...
class ProductoAdmin(admin.ModelAdmin):
    list_display = ("cod", "descripcion", "tipo", "precio_venta","precio_anterior", "stock", "thumb_f", "thumb_d", "thumb_l")
    ...
    fieldsets = (
        ("Datos del producto", {
            "fields": ("cod", "categoria", "forma", "material", "color", "stock", "marca", "descripcion", "tipo", "precio_venta", "precio_anterior", "talla_luna", "puente", "largo", "ancho", "altura", "talla", "condicion", "uso" )
        }),
        ("Fotos", {
